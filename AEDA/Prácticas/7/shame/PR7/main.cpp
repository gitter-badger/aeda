...
void demo_insertar(dra::binaryTree<dra::dni>&, bool demo = false);
void demo_eliminar(dra::binaryTree<dra::dni>&, bool demo = false);
...
{/*
    ...
    std::cout << "Voy a insertar un 60" << std::endl;
    arbol.insert(60);

    std::cout << "Voy a insertar un 70" << std::endl;
    arbol.insert(70);

    std::cout << "Voy a insertar un 80" << std::endl;
    arbol.insert(80);

    std::cout << "Voy a insertar un 90" << std::endl;
    arbol.insert(90);

    std::cout << "Voy a insertar un 5" << std::endl;
    arbol.insert(5);
...
void demo_insertar(dra::binaryTree<dra::dni>& arbol, bool demo)
{
    dra::dni dummy;
...
void demo_eliminar(dra::binaryTree<dra::dni>& arbol, bool demo)
{
    dra::dni dummy;
...
{
    dra::dni dummy;
    for(unsigned i = 0; i < banco.size(); i++){
        if(dummy == banco[i]){
            dra::dni aux;
            dummy = aux;
            i = 0;
